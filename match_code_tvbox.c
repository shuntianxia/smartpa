...
static int match_code_tvbox_proc (HWND hWnd, int message, WPARAM wParam, LPARAM lParam)
{	
	switch (message)
	{
		case MSG_ERASEBKGND:
...
static void InitCreateInfo(PMAINWINCREATE pCreateInfo)
{
    ...
    pCreateInfo->hIcon = 0;
    pCreateInfo->MainWindowProc = match_code_tvbox_proc;
    pCreateInfo->lx = 0; 
    pCreateInfo->ty = 0;
    pCreateInfo->rx = 480;
    pCreateInfo->by = 1280;
...
void match_code_tvbox (HWND hosting)
{
