...
static buttonex_info_t buttonex_info [] =
{
    ...
    },
    {
		...
		187, 519, 
		108, 108,
		{"match_code/power.png",
		"match_code/power_focus.png",
		"match_code/power_focus.png"},
		0
    },
    {
...
static int match_code_air_condition_proc (HWND hWnd, int message, WPARAM wParam, LPARAM lParam)
{	
	switch (message)
	{
		case MSG_ERASEBKGND:
...
static void InitCreateInfo(PMAINWINCREATE pCreateInfo)
{
    ...
    pCreateInfo->hIcon = 0;
    pCreateInfo->MainWindowProc = match_code_air_condition_proc;
    pCreateInfo->lx = 0; 
    pCreateInfo->ty = 0;
    pCreateInfo->rx = 480;
    pCreateInfo->by = 1280;
...
void match_code_air_condition (HWND hosting)
{
